...
const Checkout = props => {
  ...
  const nameControlClasses = `${styles.control} ${
    formInputValidaty.name ? '' : styles.invalid
  }`;

  const streetControlClasses = `${styles.control} ${
    formInputValidaty.street ? '' : styles.invalid
  }`;

  const cityControlClasses = `${styles.control} ${
    formInputValidaty.city ? '' : styles.invalid
  }`;

  const postalControlClasses = `${styles.control} ${
    formInputValidaty.postalCode ? '' : styles.invalid
  }`;
  ...
  return (
    <form className={styles.form} onSubmit={confirmHandler}>
      ...
      <div className={streetControlClasses}>
        ...
        {!formInputValidaty.street && <p>Please enter a valid street name!</p>}
      </div>
      ...
      <div className={cityControlClasses}>
        ...
        {!formInputValidaty.name && <p>Please enter a valid city name!</p>}
      </div>
